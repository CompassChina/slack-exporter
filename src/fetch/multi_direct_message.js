...
function step1(callback) {
    logger.info("Step 1: Multi Direct Message 获取Channel List");
    setTimeout(async () => {
...
async function runSteps() {
    ...
    if (args.step === 'channel') {
        try {
            ...
            logger.info(`Step 1. Multi Direct Message gel all channel list completed! Please confirm the channel list, which will be exported`);
        } catch (err) {
